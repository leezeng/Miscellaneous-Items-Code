...
import com.web.mock.MockServletConfig;
import com.web.mock.MockServletContext;
import junit.framework.TestCase;

import com.context.support.MessageSourceResolvableImpl;
import com.web.bind.EscapedErrors;
...
import com.web.servlet.mvc.BaseCommandController;
import com.web.servlet.support.RequestContext;
...
public class DispatcherServletTestSuite extends TestCase {
	...
	public DispatcherServletTestSuite() throws ServletException {
		...
		simpleControllerServlet.setContextClass("SimpleWebApplicationContext");
		simpleControllerServlet.init(servletConfig);

		complexControllerServlet = new DispatcherServlet();
		complexControllerServlet.setContextClass("ComplexWebApplicationContext");

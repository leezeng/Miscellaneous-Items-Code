...
//	}
	...
	public void testCustomEnvironment() {
		...
		// to look anything up
		je.setAsText("jndiInitialSomethingOrOther=com.myjndi.CompleteRubbish\nfoo=bar");
		JndiTemplate jt = (JndiTemplate) je.getValue();
		assertTrue(jt.getEnvironment().size() == 2);
		assertTrue(jt.getEnvironment().getProperty("jndiInitialSomethingOrOther").equals("com.myjndi.CompleteRubbish"));

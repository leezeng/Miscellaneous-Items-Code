...
package com.beans.propertyeditors;
 ...
 * @version $Id: PropertyEditorTestSuite.java,v 1.1 2003/07/31 18:54:39 jhoeller Exp $
 */
public class PropertyEditorTestSuite extends TestCase {
	...
	public void testClassEditor() {
		...
		classEditor.setAsText("TestBean");
		assertEquals(TestBean.class, classEditor.getValue());
		assertEquals("TestBean", classEditor.getAsText());
	}
